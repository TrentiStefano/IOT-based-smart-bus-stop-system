...
MQTT_TOPIC_SUB = "bus/24T/stop_rqsts"
...
def get_bus_position(elapsed_time):
    ...
    angle = omega_rad_sec * elapsed_time + math.pi 
    latitude = radius * math.sin(angle) #x
...
def on_message(client, userdata, message):
    ...
    print("Stop request payload: ", payload_json["bus_24T"])
    if(payload_json["bus_24T"] == True):
        stop = True
        print("stop = ", stop)
...
try:
    ...
    while True:
        ...
        #else:
            #print("Bus 24T position: ", latitude, "; ", longitude)
